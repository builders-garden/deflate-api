...
export const createDeposit = async (req: Request, res: Response) => {
  try {
    ...
    const { userAddress, amount, strategy } =
    ...
    const deflatePortalAddress = data?.chainId === 8453 ? process.env.BASE_DEFLATE_PORTAL_ADDRESS : process.env.POLYGON_DEFLATE_PORTAL_ADDRESS
